...
class OrderController extends AbstractController
{
    ...
    /**
     * @Route("/shop/commande", name="order")
     */
    public function index(Cart $cart, Request $request): Response
    {
        // Si l'utilisateur essaye de valider son panier sans etre enregistré, on le retourne sur la page connexion
        if (!$this->getUser())
        {
    ...
    /**
     * @Route("/shop/commande/recapitulatif", name="order_recap", methods={"POST"})
     */
